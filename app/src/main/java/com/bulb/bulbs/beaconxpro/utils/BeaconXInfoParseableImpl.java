...
import com.bulb.bulbs.beaconxpro.entity.BeaconXInfo;
import com.bulbxpro.support.beaconxpro.entity.DeviceInfo;
import com.bulbxpro.support.beaconxpro.service.DeviceInfoParseable;
 ...
 * @Author wenzheng.liu
 * @Description
 * @ClassPath com.bulb.beaconxpro.utils.BeaconXInfoParseableImpl
 */
public class BeaconXInfoParseableImpl implements DeviceInfoParseable<BeaconXInfo> {
    ...
    public BeaconXInfo parseDeviceInfo(DeviceInfo deviceInfo) {
                    ...
                    if (bytes != null) {
                        switch (bytes[0] & 0xff) {
                            case BeaconXInfo.VALID_DATA_FRAME_TYPE_INFO:
                                ...
                                battery = BulbUtils.toInt(Arrays.copyOfRange(bytes, 3, 5));
        ...
        String data = BulbUtils.bytesToHexString(values);
