package com.bulb.bulbs.beaconx.utils;

import android.text.TextUtils;

import com.bulb.bulbs.beaconx.entity.BeaconXUID;
import com.bulb.bulbs.beaconx.entity.BeaconXDevice;
import com.bulb.bulbs.beaconx.entity.BeaconXTLM;
import com.bulb.bulbs.beaconx.entity.BeaconXURL;
import com.bulb.bulbs.beaconx.entity.BeaconXiBeacon;
import com.bulb.support.beacon.utils.BulbUtils;
import com.bulbx.support.beaconx.entity.SlotData;
import com.bulbx.support.beaconx.entity.UrlExpansionEnum;
import com.bulbx.support.beaconx.entity.UrlSchemeEnum;
...
public class BeaconXParser {
    ...
    public static BeaconXDevice getDevice(String data) {
        ...
        device.deviceName = BulbUtils.hex2String(data.substring(22, data.length()));
        return device;
    }
