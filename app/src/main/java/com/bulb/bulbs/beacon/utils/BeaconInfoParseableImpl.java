package com.bulb.bulbs.beacon.utils;

import android.os.ParcelUuid;
import android.text.TextUtils;
import android.util.SparseArray;

import com.bulb.bulbs.beacon.entity.BeaconInfo;
 ...
 * @Author wenzheng.liu
 * @Description 通用解析工具类
 * @ClassPath com.bulb.beacon.utils.BeaconInfoParseableImpl
 */
public class BeaconInfoParseableImpl implements DeviceInfoParseable<BeaconInfo> {
    ...
    public BeaconInfo parseDeviceInfo(DeviceInfo deviceInfo) {
        ...
        String manufacturerSpecificData = BulbUtils.bytesToHexString(result.getScanRecord().getManufacturerSpecificData(manufacturer.keyAt(0)));
        ...
        // LogModule.i("ManufacturerSpecificData:" + BulbUtils.bytesToHexString(result.getScanRecord().getManufacturerSpecificData(manufacturer.keyAt(0))));
        ...
        for (ParcelUuid uuid : map.keySet()) {
            ...
            // 5e000000005080
            // 64000000005081
            serviceData = BulbUtils.bytesToHexString(result.getScanRecord().getServiceData(uuid));
        ...
        String versionStr = BulbUtils.hexString2binaryString(serviceData.substring(12, 14));
        ...
        int version = Integer.parseInt(BulbUtils.binaryString2hexString(versionBinary), 16);
        // distance
        int acc = Integer.parseInt(serviceData.substring(10, 12), 16);
        String mac = deviceInfo.mac;
        double distance = BulbUtils.getDistance(deviceInfo.rssi, acc);
        ...
        // log
        String log = BulbUtils.bytesToHexString(scanRecord);
        ...
        if (serviceDataUuid != null && serviceDataUuid.startsWith("0000ff01")) {
            ...
            threeAxis = BulbUtils.bytesToHexString(threeAxisBytes).toUpperCase();
        }
        // ========================================================
