package com.bulb.support.beacon.log;
 ...
 * @Author wenzheng.liu
 * @Description
 * @ClassPath com.bulb.support.log.LogModule
 */
public class LogModule {
    private static final String TAG = "bulbLog";
    private static final String LOG_FOLDER = "bulbSupport";
    ...
    public static void init(Context context) {
        ...
        Printer filePrinter = (Printer) new FilePrinter.Builder(PATH_LOGCAT)
        ...
        LogConfiguration config = new LogConfiguration.Builder()
                ...
                .build();
        XLog.init(config, new AndroidPrinter(), (com.elvishew.xlog.printer.Printer) filePrinter);
    }
