package com.bulbxpro.support.beaconxpro.log;
...
public class LogModule {
    private static final String TAG = "bulbBeaconXPro";
    private static final String LOG_FILE = "bulbBeaconXPro.txt";
    private static final String TH_FILE = "th.txt";
    private static final String LOG_FOLDER = "bulbBeaconXPro";
